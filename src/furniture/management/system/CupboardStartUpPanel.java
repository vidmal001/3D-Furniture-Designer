...
public class CupboardStartUpPanel extends JPanel {

    CupboardStartUpPanel(){
        ...
        JLabel backgroundImage = StartupUtils.createImageLabel("icons/WhatsApp Image 2024-04-08 at 14.13.53.jpeg", 0, 0, 1540, 760);
        ...
        button2d.addActionListener(e -> {
            JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(CupboardStartUpPanel.this);
            CardLayout cardLayout = (CardLayout) frame.getContentPane().getLayout();
            cardLayout.show(frame.getContentPane(), "CupboardDisplay2d");
        });
        add(button2d);
        ...
        button3d.addActionListener(e -> {
            JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(CupboardStartUpPanel.this);
            CardLayout cardLayout = (CardLayout) frame.getContentPane().getLayout();
            cardLayout.show(frame.getContentPane(), "CupboardDisplay");
        });
        add(button3d);
        add(backgroundImage);
    }
